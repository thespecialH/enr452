...
//this function reads a pin
bool readPin(GPIO_TypeDef *port, uint32_t pin) {
	uint32_t pin_status;

	switch (pin) {
		case 0:
			pin_status = port->IDR.bit0;
			break;
		case 1:
			pin_status = port->IDR.bit1;
			break;
		case 2:
			pin_status = port->IDR.bit2;
			break;
		case 3:
			pin_status = port->IDR.bit3;
			break;
		case 4:
			pin_status = port->IDR.bit4;
			break;
		case 5:
			pin_status = port->IDR.bit5;
			break;
		case 6:
			pin_status = port->IDR.bit6;
			break;
		case 7:
			pin_status = port->IDR.bit7;
			break;
		case 8:
			pin_status = port->IDR.bit8;
			break;
		case 9:
			pin_status = port->IDR.bit9;
			break;
		case 10:
			pin_status = port->IDR.bit10;
			break;
		case 11:
			pin_status = port->IDR.bit11;
			break;
		case 12:
			pin_status = port->IDR.bit12;
			break;
		case 13:
			pin_status = port->IDR.bit13;
			break;
		case 14:
			pin_status = port->IDR.bit14;
			break;
		case 15:
			pin_status = port->IDR.bit15;
			break;
	}
