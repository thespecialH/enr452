...
typedef struct
{
	reg32bit MODER; //Mode register 0x00
	reg32bit OTYPER; //output type registers 0x04
	reg32bit OSPEEDR; //output speed register 0x08
	reg32bit PUPDR; //port pull-up/-down register 0x0C
